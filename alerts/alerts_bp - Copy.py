...
from core.core_imports import ALERT_LIMITS_PATH, JsonManager, get_locker, log, retry_on_locked
        ...
        output = []
        for alert in alerts:
            wallet_meta = resolve_wallet_metadata(alert, data_locker)
            ...
            output.append({
                ...
                "position_type": alert.get("position_type"),
                ...
                # ✅ Add wallet data
                "wallet_name": wallet_meta.get("wallet_name"),
                "wallet_image": wallet_meta.get("wallet_image"),
